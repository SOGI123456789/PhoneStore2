      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li><a href="#"><i class="icon fa fa-user"></i> Đăng ký/Đăng nhập</a></li>
          </ul>
        </div>
        <!-- /.cnt-account -->
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown yamm mega-menu"> <a href="home" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">iPhone</a>
                  <ul class="dropdown-menu container">
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">iPhone 14 Series</h2>
                            <ul class="links">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">iPhone 13 Series</h2>
                            <ul class="links">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">iPhone 12 Series</h2>
                            <ul class="links">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">iPhone 11 Series</h2>
                            <ul class="links">
                          ...
                          <!-- /.col -->
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">iPhone XS / iPhone XS Max</h2>
                            <ul class="links">
                          ...
                          <!-- /.col -->
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <h2 class="title">iPhone X / iPhone XR</h2>
                            <ul class="links">
                ...
                <a href="category" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">iPad <span class="menu-label hot-menu hidden-xs">hot</span> </a>
                  <ul class="dropdown-menu container">
                    <li>
                      <div class="yamm-content">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                            ...
                            <ul class="links">
                              <li><a href="#">iPad Mini 2 Wifi 4G</a></li>
                            </ul>
                          </div>
                          <!-- /.col -->
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                            ...
                            <ul class="links">
                              <li><a href="#">iPad Air Wifi 4G</a></li>
                              <li><a href="#">iPad Air 2 Wifi 4G</a></li>
                            </ul>
                          </div>
                          <!-- /.col -->
                ...
                <li class="dropdown hidden-sm"> <a href="category"><span class="menu-label new-menu hidden-xs">new</span> </a> </li>
                <li class="dropdown hidden-sm"> <a href="category">Apple Watch</a> </li>
                <li class="dropdown"> <a href="contact">SamSung</a> </li>
                <li class="dropdown"> <a href="contact">Oppo</a> </li>
                <li class="dropdown"> <a href="contact">Xiaomi</a> </li>
                <li class="dropdown"> <a href="contact">Vivo</a> </li>
                <li class="dropdown"> <a href="contact">Realme</a> </li>
                <li class="dropdown"> <a href="contact">Phụ kiện</a> </li>
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-shopping-bag" aria-hidden="true"></i>iPhone</a>
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-laptop" aria-hidden="true"></i>iPad</a> 
                <!-- ================================== MEGAMENU VERTICAL ================================== -->
                <ul class="dropdown-menu mega-menu">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-paw" aria-hidden="true"></i>Apple Watch</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-clock-o"></i>SamSung</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-diamond"></i>Oppo</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-heartbeat"></i>Xiaomi</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-paper-plane"></i>Vivo</a> 
                <!-- /.dropdown-menu --> </li>
              <!-- /.menu-item -->
              
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-futbol-o"></i>Realme</a> 
                <!-- ================================== MEGAMENU VERTICAL ================================== --> 
                <!-- /.dropdown-menu --> 
                <!-- ================================== MEGAMENU VERTICAL ================================== --> </li>
              <!-- /.menu-item -->
              
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-envira"></i>Phụ kiện</a> 
                <!-- /.dropdown-menu --> </li>
              <!-- /.menu-item -->
            ...
            <div class="row">
              <div class="col-md-4 col-sm-2 col-lg-3">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green" style="color:black;">Realmi 10 5G chưa đến 4 triệu</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-2 col-lg-3">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green" style="color:black;">Realme 10 Pro Plus giảm giá</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-2 col-lg-3">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green" style="color:black;">Xiaomi Redmi K50 cực rẻ</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-2 col-lg-3">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green" style="color:black;">Redmi K60 5G Snap 8+ gen 1</h4>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="blog-slider-container outer-top-xs">
            <div class="owl-carousel blog-slider custom-carousel">
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog"><img src="assets\images\blog-post\post1.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog"><img src="assets\images\blog-post\post2.jpg" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
