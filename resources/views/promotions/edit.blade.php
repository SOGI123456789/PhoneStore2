                            ...
                            <div class="form-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('max_discount_amount') is-invalid @enderror" 
                                           ...
                                           value="{{ old('max_discount_amount', $promotion->max_discount_amount) }}" step="1000" min="0">
                                    @error('max_discount_amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Để trống nếu  nếu chọn phần trăm</small>
                                </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('min_order_value') is-invalid @enderror" 
                                           ...
                                           value="{{ old('min_order_value', $promotion->min_order_value) }}" step="1000" min="0">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="is_active">
                                            <i class="fas fa-toggle-on text-success"></i> Kích hoạt khuyến mại
                                        </label>
                                    </div>
                                    <small class="form-text text-muted">Bỏ tick để tạm dừng khuyến mại</small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="applies_to" id="applies_all" value="all" 
                                               {{ old('applies_to', $promotion->applies_to) == 'all' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="applies_to" id="applies_products" value="specific_products"
                                               {{ old('applies_to', $promotion->applies_to) == 'specific_products' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="applies_to" id="applies_categories" value="specific_categories"
                                               {{ old('applies_to', $promotion->applies_to) == 'specific_categories' ? 'checked' : '' }}>
                                ...
                                <!-- Thông tin sử dụng (chỉ hiển thị) -->
                                @if($promotion->used_count > 0)
                                    <div class="alert alert-info">
                                        <h6><i class="fas fa-info-circle"></i> Thông tin sử dụng:</h6>
                                        <p class="mb-1">
                                            <strong>Đã sử dụng:</strong> {{ $promotion->used_count }}
                                        ...
                                        @if($promotion->usage_limit && $promotion->used_count >= $promotion->usage_limit)
                                            <p class="mb-0 text-warning">
                                                <i class="fas fa-exclamation-triangle"></i> Khuyến mại đã hết lượt sử dụng
                                            </p>
                                        @endif
                                    </div>
                                @endif
...
$(document).ready(function() {
    console.log('Document ready - initializing edit form');
